...
public class ProducerDemoWithCallback {
    public static void main(String[] args) {
       ...
       for (int i = 0; i <= 20; i++){
           ...
           ProducerRecord<String, String> record = new ProducerRecord<String, String>("first_topic", "Hello World Message" + (i +400));
...
//                               "Partition: " + recordMetadata.topic() + "\n" +
...
//           // TODO: check if this is good practice for kafka consumer with callback - annnd it is :)
